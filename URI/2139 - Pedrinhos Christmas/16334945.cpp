...
{
    int day_passed = 0;
    for(int i = 0 ; i < m-1 ; i++)day_passed+=arr[i];
    day_passed+=d;

    if(day_passed==360)cout << "E natal!" <<endl;
    else if ( day_passed ==359 )cout << "E vespera de natal!" <<endl;
    else if ( day_passed > 360 ) cout << "Ja passou!" <<endl;
    else cout << "Faltam "<< 360 - day_passed <<" dias para o natal!" <<endl;
